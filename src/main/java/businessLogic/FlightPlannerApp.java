...
//                System.out.println("Updated Price: " + updatedPrice);*/
    ...
    private void showUpdateFlightStatus() {
        ...
        updateFlightStatusBtn.setOnAction(_ -> {
            ...
            if (flightNumber.isEmpty() || newDepartureDate == null || newArrivalDate == null || notificationType == null) {
    ...
    private void showAddFlightForm() {
        ...
        addFlightBtn.setOnAction(_ -> {
            ...
            Route route = flightPlanner.getRouteByAirportsCode(departure,arrival);
            if(flightPlanner.checkRouteNotExistence(route.getRouteId())){
                showAlert(Alert.AlertType.ERROR,"Invalid Flight Addition","No route is available for this flight.");
                return;
            }
            ...
            if(economySeatsNumber + businessSeatsNumber + firstSeatsNumber < 1){
                showAlert(Alert.AlertType.ERROR,"Insufficient Seats","A flight must have at least one seat!");
                return;
            }
